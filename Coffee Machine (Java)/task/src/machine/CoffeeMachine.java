...
public class CoffeeMachine {
    ...
    public static void buy() {
        ...
        switch (input) {
            case "1" -> prepareCoffee(CoffeeStandards.ESPRESSO);
            case "2" -> prepareCoffee(CoffeeStandards.LATTE);
            case "3" -> prepareCoffee(CoffeeStandards.CAPPUCCINO);
            case "back" -> action();
        }
    }

    public static void prepareCoffee (CoffeeStandards coffeeStandards) {
